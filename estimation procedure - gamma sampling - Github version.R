...
# inf_f - inflation factor. If, in order to save computation time, only a sub-sample of the censored observations is used, a factor of (number of sampled censored obs)/(number of total censored obs) should be assigned to the weight of each such observation
